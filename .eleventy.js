...
module.exports = function(eleventyConfig){
  ...
  // Add this line to recognize the data directory and others
  eleventyConfig.addPassthroughCopy('_data');
  eleventyConfig.addPassthroughCopy('_includes');
  eleventyConfig.addPassthroughCopy('_layouts');
  eleventyConfig.addPassthroughCopy('_templates');
  // Official plugins
...
function delay(ms) {
  ...
  // Here ends the code related to the favicon file
